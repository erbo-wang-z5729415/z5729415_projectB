...
- [ *] Folder is named <yourZID>_projectB (for example z3539841_projectB).
...
- [ *] streamlit_app.py runs locally: streamlit run streamlit_app.py.
- [ *] The GitHub repo is PUBLIC and the live Streamlit app loads.
- [ *] Raw data loads through src/data_access.py; no raw data or secrets committed.
      (Your derived results/ artifacts - the CSVs the app reads - ARE committed.)
- [ *] AGENTS.md or CLAUDE.md (your tool's file) is YOUR own, not the stub.
- [ *] ai/ contains your prompt logs and AI notes.
